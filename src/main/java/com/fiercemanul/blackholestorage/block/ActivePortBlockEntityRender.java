...
@OnlyIn(Dist.CLIENT)
public class ActivePortBlockEntityRender implements BlockEntityRenderer<ActivePortBlockEntity> {

    public ActivePortBlockEntityRender(BlockEntityRendererProvider.Context context) {
    }
    @Override
    public void render(ActivePortBlockEntity t, float partialTicks, PoseStack poseStack, MultiBufferSource bufferSource, int combinedLight, int combinedOverlay) {
